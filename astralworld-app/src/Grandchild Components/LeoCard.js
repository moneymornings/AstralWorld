...
import background from '../Leo.png';
...
function LeoCard() {
    ...
    fetch("https://horoscope-astrology.p.rapidapi.com/sign?s=leo", requestOptions)
    .then((response)=> response.json())
    .then((result) => {
      setLeo(result.about); //fetches horoscope data for sign and updates the state to that horoscope.
